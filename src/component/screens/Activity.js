...
import { FriendsProfileData } from '../screenComponent/Database';
...
const Activity = () => {
  ...
  return (
    <View style={{height: '100%', width: '100%', backgroundColor: 'white'}}>
      <Text style={{
        fontSize: 20, fontWeight: 'bold', borderBottomWidth: 0.5,
        borderBottomColor: '#dedede', padding: 10,
      }}>Activity</Text>
                ...
                <View style={{
                  ...
                  <TouchableOpacity style={{
                    ...
                    <Image source={data.profileImage} style={{
                      width: 45, height: 45, borderRadius: 100, marginRight: 10
                    }}/>
                  ...
                  style={{width: follow ? 72 : 68}}>
                    <View style={{
                      ...
                      backgroundColor: follow ? null : '#3493d9', borderWidth: follow ? 1 : 0, 
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    {
                      follow ? (
                        <TouchableOpacity onPress={()=> setFollow(!follow)}
                          ...
                          <View style={{width: '100%', height: 30, borderRadius: 5, backgroundColor: follow ? null : '#3493d9',
                          borderWidth: follow ? 1 : 0, borderColor: '#dedede', justifyContent: 'center', alignItems: 'center'}}>
                            <Text style={{color: follow ? '#000' : '#fff'}}>{follow ? 'following' : 'follow'}</Text>
                          </View>
                        </TouchableOpacity>
                      ) : (
                        <>
                          ...
                          <TouchableOpacity onPress={()=>setClose(true)} style={{paddingHorizontal: 10}}>
                            <AntDesign name='close' style={{fontSize: 14, color: '#000', opacity: 0.8}}/>
                          </TouchableOpacity>
                        </>
                      )
                    }
